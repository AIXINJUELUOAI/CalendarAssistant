...
📱 截图展示
主界面 (日程视图)	新增/编辑日程	快捷设置磁贴	识别成功通知
<img src="docs/screenshots/home.jpg" width="200"/>	<img src="docs/screenshots/edit.jpg" width="200"/>	<img src="docs/screenshots/tile.jpg" width="200"/>	<img src="docs/screenshots/notification.jpg" width="200"/>
(请将你的 App 截图放入项目 docs/screenshots/ 文件夹下，并替换上述文件名)
🚀 快速开始
1. 安装
